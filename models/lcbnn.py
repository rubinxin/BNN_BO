...
class LCBNNWarp(BaseModel):
    ...
    def __init__(self, mini_batch_size=10,num_epochs=1000,
                 n_units=[50, 50, 50],
                 dropout = 0.05, length_scale = 1e-1, T = 100, util_type='se_ytrue_clip',
                 normalize_input=True, normalize_output=True, seed=42, actv='tanh', saving_path = './'):
        ...
        self.model = LCBNN(batch_size=mini_batch_size,num_epochs=num_epochs,
                 ...
                 weights=None, util_type=util_type, actv=actv, model_saving_path=self.model_saving_path)
