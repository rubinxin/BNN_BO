...
from pybnn.mcconcretedrop_test_n_hidden import MCCONCRETEDROP
from pybnn.lccd_test_n_hidden import LCCD
import time
...
def fitting_new_points_1D(n_units, num_epochs, seed, T, length_scale, n_init, mc_tau, regul, warm_start,
    ...
    for k in range(total_itr):
        ...
        model_concdrop = MCCONCRETEDROP(num_epochs=num_epochs, n_units=n_units_list, length_scale=length_scale, T=T,
        ...
        for u in util_set:
            ...
            model_lccd_u = LCCD(num_epochs=num_epochs, n_units=n_units_list,
