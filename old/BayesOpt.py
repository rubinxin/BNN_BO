...
class Bayes_opt():
    ...
    def initialise(self, X_init=None, Y_init=None, kernel=None, n_fmin_samples=1):
    ...
    def iteration_step(self, iterations, seed, bo_method):
        ...
        if bo_method == 'EI':
            ...
            fmin_samples = sample_fmin_Gumble(self.GP_model, self.bounds, nMs=self.n_fmin_samples)
            self.GP_model.fmin_samples = fmin_samples
            acqu_func = MES(self.GP_model)
