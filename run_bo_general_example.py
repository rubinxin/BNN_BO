...
f, x_bounds, _, true_fmin = get_function('egg-2d')
# obj_func = egg
var_noise = 1.0e-10
d = x_bounds.shape[0]
n_init = 3
...
for j in range(seed_size):
    ...
    bayes_opt.initialise(x_init, y_init, model_type='DropNN')

    # output of Bayesian optimisation:
    X_query,Y_query,X_opt,Y_opt= bayes_opt.iteration_step(iterations=50, seed=seed,bo_method='MES')
